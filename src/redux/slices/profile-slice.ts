...
export const updateProfileAvatar = createAsyncThunk<UserProfile, FormData>(
  'userProfile/updateProfileAvatar',
  async (formData) => {
...
export const removeProfileAvatar = createAsyncThunk<UserProfile>(
  'userProfile/removeProfileAvatar',
  async () => {
...
export const removeUserAccount = createAsyncThunk<void>(
  'userProfile/removeUserAccount',
  async () => {
